-- =====================================================
-- COSTS TABULKA - SQL PRO VYTVOŘENÍ
-- =====================================================

-- Vytvoření tabulky costs
...
-- Vložení ukázkových dat pro user_id = 1
...
(1, 'Software licence', 'SaaS nástroje', 8000.00, 'fixed', 'monthly', 'IT', '2026-01-01'),
(1, 'Účetnictví', 'Služby účetní', 5000.00, 'fixed', 'quarterly', 'Služby', '2026-01-01');

-- Kontrola
SELECT COUNT(*) as 'Počet nákladů' FROM costs;
